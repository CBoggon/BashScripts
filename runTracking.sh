...
# Program loops through all image sequence folders within specified file path, creating output folders containing the outputs of findRods2Dt and trackRods2Dt
